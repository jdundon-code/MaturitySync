...
Navigate to the /demo folder in the repository.

Open decision-hub.html directly in your web browser. This file contains all UI flows, states, and the Nymbus Joy design system implementation.
...
Push the database schema and seed the mock data:
